...
import com.example.androidvolleytest.app.AppController;
import com.example.androidvolleytest.net_utils.Const;
...
public class StringRequestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStringReq = (Button) findViewById(R.id.btnStringRequest);
